...
class UserController extends Controller
{
    public function index() {
        ...
        $aBusLine = ($spTrans->seekLines("5141", BusLine::WAY_FIRST_LEG))[1]; //The first match of a line search
        $busStops = $spTrans->seekBusStops("Afonso"); //all stops served by $aBusLine
